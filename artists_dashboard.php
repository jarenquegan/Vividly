        ...
        <div class="container">
            <?php if (count($actrand) > 0) { ?>
                <div style="margin-bottom: 10px; display: flex; align-items: center;">
                    <h3 class="spanspan">
                        <?php echo strtoupper("Registered Artists"); ?>
                    </h3>
                    <span><?= "ARTISTS: " . count($actrand) . " | "; ?><a href="add_artist.php?addArtist=true" class="dashspan">ADD +</a></span>
                </div>
            ...
            <?php if (count($actrand) == 0) { ?>
                <div class="no-results">
                    <a href="add_artist.php?addArtist=true" class="dashspan"><i class='bx bx-plus'></i></a>
                    <p><br>No artists found.<br>Click on the plus icon to add an artists.</p>
                </div>
            <?php } ?>
        </div>
    </section>
