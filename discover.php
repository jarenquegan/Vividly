    ...
    <header>
        ...
        <div class="nav container">
            ...
            <div class="navbar">
                ...
                <a href="discover.php" class="nav-link nav-active">
    ...
    <section class="result-container">
        <div class="container">
            <?php if (count($artworksWithArtists) > 0) { ?>
                <h3 style="margin-bottom: 10px; display: flex; align-items: center;"><?php echo strtoupper("Discover more arts"); ?></h3>
            ...
            <?php } ?>
            <?php if (count($artworksWithArtists) == 0 && count($artworksWithArtists) == 0) { ?>
