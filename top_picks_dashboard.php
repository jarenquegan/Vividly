...
// PHP code to fetch the top 5 most liked artworks
    ...
    <header>
        ...
        <div class="nav container">
            ...
            <div class="navbar">
                ...
                <a href="top_picks_dashboard.php" class="nav-link  nav-active">
        ...
        <div class="container">
            <?php if (count($results) > 0) { ?>
                <div style="margin-bottom: 10px; display: flex; align-items: center;">
                    <h3 class="spanspan">
                        <?php echo strtoupper("Top 10 most Liked"); ?>
                    </h3>
                    <span>
                        <?php
                ...
                <ul class="artwork-list">
                    <?php foreach ($results as $result) { ?>
                        <li>
                            <span href="open-now.php?id=<?php echo $result['artwork_id']; ?>" class="artwork-link">
            ...
            <?php if (count($results) == 0) { ?>
                <div style="margin-bottom: 10px; display: flex; align-items: center;">
                    <h3 class="spanspan">
                        <?php echo strtoupper("Top 5 most Liked"); ?>
                    </h3>
                    <span>
                        <?php
                        // Get the current date
